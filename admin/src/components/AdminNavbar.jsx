...
function AdminNavbar() {
  ...
  return (
    <nav className="relative px-4 py-4 flex justify-between items-center bg-burgundy-600 shadow-md">
      {/* Logo */}
      <a href="/prestige-admin/home" className="flex items-center space-x-2">
      ...
      <ul className="hidden lg:flex lg:items-center lg:space-x-6 text-white font-medium tracking-wide">
        {[
          { to: "/prestige-admin/home", icon: Home, label: "Home" },
          { to: "/prestige-admin/tenants", icon: Users, label: "Tenants" },
          { to: "/prestige-admin/visitors", icon: UserPlus, label: "Visitors" },
          {
            to: "/prestige-admin/bookings",
            icon: WalletCards,
            label: "Booking & Payments",
          },
          {
            to: "/prestige-admin/issue-reports",
            icon: BadgeAlert,
            label: "Issue Reports",
          },
          {
            to: "/prestige-admin/advertisements",
            icon: Megaphone,
